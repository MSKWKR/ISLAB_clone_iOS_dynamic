...
function app_meta_info(DEBUG) {
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('CFBundleDisplayName')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('CFBundleExecutable')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('CFBundleIdentifier')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('CFBundleInfoDictionaryVersion')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('CFBundleNumericVersion')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('CFBundleShortVersionString')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('MinimumOSVersion')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('CFBundlePackageType')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('BuildMachineOSBuild')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('CFBundleDevelopmentRegion')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  try {
    console.log(
        'iPhone Environment Required: ' +
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('LSRequiresIPhoneOS')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
...
function xcode_build_meta_info(DEBUG) {
  ...
  try {
    console.log(
        ...
        ObjC.classes.NSBundle.mainBundle()
            .infoDictionary()
            .objectForKey_('DTPlatformVersion')
            .toString())
  } catch (err) {
    if (DEBUG) {
      console.error('[!] Error: ' + err.message);
  ...
  // try { console.log("NSAppTransportSecurity: " +
  // ObjC.classes.NSBundle.mainBundle().infoDictionary().objectForKey_("NSAppTransportSecurity").toString())
}
function app_env_info(DEBUG) {
  ...
  // Credit:
  // https://github.com/iddoeldor/frida-snippets#find-ios-application-uuid
  var mainBundleContainerPathIdentifier = '';
  var bundleIdentifier =
      String(ObjC.classes.NSBundle.mainBundle().objectForInfoDictionaryKey_(
          'CFBundleIdentifier'));
  ...
  var folders = ObjC.classes.NSFileManager.defaultManager()
                    .contentsOfDirectoryAtPath_error_(path_prefix, NULL);
  for (var i = 0, l = folders.count(); i < l; i++) {
    var uuid = folders.objectAtIndex_(i);
    var metadata = path_prefix + uuid + plist_metadata;
    var dict = ObjC.classes.NSMutableDictionary.alloc().initWithContentsOfFile_(
        metadata);
  ...
  console.log(
      'App Container Path : /var/mobile/Containers/Data/Application/' +
      mainBundleContainerPathIdentifier + '/')
}
  ...
  for (var i = 0; i < dictKeys.count(); i++) {
    if (dictKeys.objectAtIndex_(i) == 'CFBundleURLSchemes') {
      ...
      for (var i = 0; i < nsArray.count(); i++) {
        urlSchemesString =
            urlSchemesString + nsArray.objectAtIndex_(i).toString() + ', ';
      }
  ...
  if (dictKeys.containsObject_('NSAppTransportSecurity')) {
    ...
    for (var i = 0; i < atsDictKeys.count(); i++) {
      ...
      if (atsDictKeys.objectAtIndex_(i) == 'NSExceptionDomains') {
        ...
        ObjC.classes.NSBundle.mainBundle().infoDictionary().objectForKey_("NSAppTransportSecurity").objectForKey_("NSExceptionDomains");
        var atsExceptionDomainsDictKeys =
        ObjC.classes.NSBundle.mainBundle().infoDictionary().objectForKey_("NSAppTransportSecurity").objectForKey_("NSExceptionDomains").allKeys();
        for( var i = 0; i<atsExceptionDomainsDictKeys.count(); i++)
        {
                console.log("Domain Name : " + atsExceptionDomainsDict);
                if(ObjC.classes.NSBundle.mainBundle().infoDictionary().objectForKey_("NSAppTransportSecurity").objectForKey_("NSAllowsArbitraryLoads").toString()
        == "1")
                {
                        console.log("[*] Issue: ")
                        console.log("[*] Detail: ")
